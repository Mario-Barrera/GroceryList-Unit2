 ...
 */
function logNames(items) {              // TODO: use `forEach`
  items.forEach((item) => {
 ...
 */
function getUppercaseNames(items) {                       // TODO: use `map`
 ...
 */
function getItemById(items, id) {                           // TODO: use `find`
 ...
 */
function getItemPriceByName(items, name) {                                // TODO: use a loop!
  let price = null; 
  items.forEach((item) => {
    if (item.name === name) {
      price = item.price;
 ...
 */
function getItemsByCategory(items, category) {                          // TODO: use `filter`
 ...
 */
function countItems(items) {                              // TODO: use `reduce`
  return items.reduce(
 ...
 */
function calculateTotalPrice(items) {                       // TODO: use `reduce`
  return items.reduce(
...
/* Added these statements as per Nishant instructions */       
console.log(INVENTORY.slice(5));                      // Logs all items from index 5 to the end
console.log(INVENTORY.slice(1, 5));                   // Logs items from index 1 to index 4 (not including 5)